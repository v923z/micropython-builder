...
build_rp2_uart_vfat() {
    make ${MAKEOPTS} -C micropython/ports/rp2 BOARD=$1 USER_C_MODULES=../../../ulab/code/micropython.cmake CFLAGS_EXTRA=-DULAB_HASH=$ulab_hash -DMICROPY_HW_ENABLE_UART_REPL=1 -DMICROPY_HW_USB_MSC=1
